...
public static class AbpHideTenantSwitchEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE AbpHideTenantSwitchModuleExtensionConfigurator CLASS (in the Domain.Shared project)
