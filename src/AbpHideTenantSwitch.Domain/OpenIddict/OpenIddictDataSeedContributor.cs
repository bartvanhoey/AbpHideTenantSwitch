...
namespace AbpHideTenantSwitch.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AbpHideTenantSwitch") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AbpHideTenantSwitch", DisplayName = "AbpHideTenantSwitch API", Resources = { "AbpHideTenantSwitch" }
            });
        }
    }
